...
public class SimplifiedOdometryRobot {
    ...
    public boolean readSensors() {
        ...
        double y_mm = pinpoint.getPosY();
        double x_mm = pinpoint.getPosX();

        // Convert mm → counts if you still want counts
        int yCounts = (int)(y_mm / ODOM_INCHES_PER_COUNT);
        int xCounts = (int)(x_mm / ODOM_INCHES_PER_COUNT);
        ...
        if (showTelemetry) {
            ...
            myOpMode.telemetry.addData("Distance Ax:Lat", "%5.2f %5.2f", driveDistance, strafeDistance);
